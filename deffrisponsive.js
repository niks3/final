...
(function(global, factory) {
    ...
    var SLIDES_PREV =           'strelal';
    var SLIDES_PREV_SEL =       '.' + SLIDES_PREV;
    var SLIDES_ARROW_PREV =     SLIDES_ARROW + ' ' + SLIDES_PREV;
    var SLIDES_ARROW_PREV_SEL = SLIDES_ARROW_SEL + SLIDES_PREV_SEL;
    var SLIDES_NEXT =           'strelad';
        ...
        function addTouchHandler(){
            if(isTouchDevice || isTouch){
				...
				var w = window.innerWidth;
  				var h = window.innerHeight;
                if(w < 1200){
					$(WRAPPER_SEL).on('touchstart ' +  MSPointer.down).on('touchstart ' + MSPointer.down, touchStartHandler);
					$(WRAPPER_SEL).on('touchmove ' + MSPointer.move).on('touchmove ' + MSPointer.move, touchMoveHandler);
				}else{
